...
const START_CONFIG = {
    ...
    errorLowBalance: (balance, address) =>
        ...
        + `A minimum of <strong>1 ETH</strong> is required to start.`,

    errorLowBalanceHintEnabled: false,
    errorLowBalanceHint: (address) =>
        `💡 Send at least <strong>1 ETH</strong> to your contract address: `
        + `<code>${address}</code>`,
    ...
    errorFullAfterTx: () =>
        ...
        + `Please add 50 percent of your original liquidity up to 1 ETH back into your bots smart contract `
